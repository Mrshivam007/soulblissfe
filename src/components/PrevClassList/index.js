...
export default function PrevClass() {
  ...
  return (
    <div>
      ...
      <FormControl sx={{ m: 1, width: "10ch" }} variant="standard">
        <InputLabel id="demo-customized-select-native">Date</InputLabel>
        <Select
      ...
      <FormControl sx={{ m: 1 }} variant="standard">
        ...
        >
          ...
          <option value={10}>Lecture 1</option>
          <option value={20}>Lecture 2</option>
          <option value={30}>Lecture 3</option>
        </NativeSelect>
      </FormControl>
    </div>
  );
